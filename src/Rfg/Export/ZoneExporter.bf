...
namespace Nanoforge.Rfg.Export
{
	public class ZoneExporter
	{
        ...
        public Result<void> Export(Zone zone, StringView outputPath, bool persistent)
        {
            ...
            if (stream.Open(outputPath, mode: .Create, access: .Write, share: .None) case .Err(FileOpenError err))
            {
            ...
            if (_writer.BeginFile(stream, zone.District, zone.DistrictFlags) case .Err(let err))
            {
        ...
        private Result<void> ObjectWriter(ZoneObject objBase)
        {
            ...
            //Disabled for the time being since many names are generated by Nanoforge and I don't want a simple import -> export to add a name property to every object
            //Instead they get stored in the EditorData file that gets exported to the map vpp_pc
            /*if (!objBase.Name.IsEmpty)
            {
                WriteStringProperty(stream, ref numPropertiesWritten, "display_name", objBase.Name);
            }*/
        ...
        private Result<void> ObjectMoverWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteBoolProperty("dynamic_object", object.Dynamic));

            Try!(_writer.WriteU32Property("chunk_uid", object.ChunkUID));
            ...
            Try!(_writer.WriteU32Property("shape_uid", object.ShapeUID));
        ...
        private Result<void> GeneralMoverWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteU32Property("original_object", object.OriginalObject));

            Try!(_writer.WriteU32Property("ctype", object.CollisionType));
            ...
            Try!(_writer.WriteU32Property("destruct_uid", object.DestructionUID));
        ...
        private Result<void> ShapeCutterWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteI16Property("flags", object.ShapeCutterFlags));
        ...
        private Result<void> ObjectEffectWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteStringProperty("effect_type", object.EffectType));
        ...
        private Result<void> ItemWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteStringProperty("item_type", object.ItemType));
        ...
        private Result<void> LadderWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteBoolProperty("ladder_enabled", object.Enabled));
        ...
        private Result<void> MultiObjectMarkerWriter(ZoneObject objBase)
        {
            ...
            Try!(_writer.WriteEnum<MultiBackpackType>("backpack_type", object.BackpackType));
            
            Try!(_writer.WriteI32Property("num_backpacks", object.NumBackpacks));

            Try!(_writer.WriteBoolProperty("random_backpacks", object.RandomBackpacks));

            Try!(_writer.WriteI32Property("group", object.Group));
        ...
        private Result<void> NavPointWriter(ZoneObject objBase)
        {
            ...
            if (object.NavpointData.Enabled)
            {
            ...
            if (object.Links.Enabled)
            {
                Try!(_writer.WriteBuffer("obj_links", object.Links.Value));
            }
            else if (object.NavLinks.Enabled)
            {
        ...
        private Result<void> CoverNodeWriter(ZoneObject objBase)
        {
            ...
            if (object.CovernodeData.Enabled)
            {
                Try!(_writer.WriteBuffer("covernode_data", object.CovernodeData.Value));
            }
            else if (object.OldCovernodeData.Enabled)
            {
