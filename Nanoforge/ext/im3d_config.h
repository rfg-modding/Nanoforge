...
//Todo: Add more conversion operators & constructors
// Conversion to/from application math types.
//#define IM3D_VEC2_APP \
//    Vec2(const ImVec2& vec) { x = vec.x; y = vec.y; } \
//    operator ImVec2() const { return ImVec2(x, y); } \
//    Vec2 operator=(const ImVec2& vec) { return Vec2(vec.x, vec.y); } \
//    Vec2 operator*(const ImVec2& vec) { return Vec2(x * vec.x, y * vec.y); } \ 
