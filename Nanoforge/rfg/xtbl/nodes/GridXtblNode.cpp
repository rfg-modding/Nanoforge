...
void GridXtblNode::InitDefault()
{

}

bool GridXtblNode::WriteModinfoEdits(tinyxml2::XMLElement* xml)
{
...
bool GridXtblNode::WriteXml(tinyxml2::XMLElement* xml, bool writeNanoforgeMetadata)
{
    //Make another xml element and write edited subnodes to it
    auto* gridXml = xml->InsertNewChildElement(Name.c_str());
    for (auto& subnode : Subnodes)
