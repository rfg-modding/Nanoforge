...
//Note: There's a separate triplanar mapping toggle for high lod terrain in Terrain.hlsl
...
//Adjustable per material scaling to reduce tiling. Only used by triplanar mapping functions. Otherwise the ones in the vertex shader are used.
