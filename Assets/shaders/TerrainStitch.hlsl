...
VS_OUTPUT VS(float4 inPos : POSITION, float4 inNormal : NORMAL)
{
    ...
    output.UvBase = posWorld.xz / 511.0f;//(posWorld.xz % 511.0f);// / 511.0f;
    ...
    // output.Uv0 = output.UvBase;
    // output.Uv1 = output.UvBase;
    // output.Uv2 = output.UvBase;
    // output.Uv3 = output.UvBase;
